...
public class KeyCloakServerRule implements TestRule {
   public static final String KEYCLOAK_IMAGE = System.getProperty("quay.io/keycloak/keycloak:10.0.1",TestSystemPropertyNames.KEYCLOAK_IMAGE);
   ...
   private void before(Class<?> testClass) {
      ...
      environment.put(System.getProperty("KEYCLOAK_USER",TestSystemPropertyNames.KEYCLOAK_USER), "keycloak");
      environment.put(System.getProperty("KEYCLOAK_PASSWORD",TestSystemPropertyNames.KEYCLOAK_PASSWORD), "keycloak");
